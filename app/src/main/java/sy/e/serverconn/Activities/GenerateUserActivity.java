...
import sy.e.serverconn.Utils.Users;
import sy.e.serverconn.Utils.UsersAdapter;
import sy.e.serverconn.Utils.UsersIntRandom;
import sy.iyad.mikrotik.MikrotikServer;
import sy.iyad.mikrotik.Models.ExecutionEventListener;
import static sy.e.serverconn.ServerInformations.USER_PROFILES;
...
public class GenerateUserActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView((int) R.layout.activity_gu);
