...
public class ServerInformations {
    ...
    public static final String[] SERVERKEYWORDS={
            ...
            "accounting",  "arp" ,   "dhcp-client" , "dhcp-server",  "firewall" , "ipsec"   ,     "neighbor" , "pool"  , "route"  ,  "settings" , "socks"  ,"tftp"        ,  "upnp",
            "address"    , "cloud" , "dhcp-relay",   "dns",          "hotspot",   "kid-control",  "packing" ,  "proxy"  ,"service",  "smb"   ,    "ssh"  ,  "traffic-flow" , "export",
            ...
            "backup"   ,"default-configuration" , "history"  , "license" , "ntp"  ,     "routerboard",  "upgrade" ,  "check-installation" , "reset-configuration" , "ssh"    ,     "telnet",
    "clock"  ,  "gps"     ,               "identity" , "logging" , "package" ,  "scheduler"  ,  "ups"     ,            "serial-terminal"   ,   "ssh-exec",
    "health"       ,          "leds"   ,   "note"    , "resource" , "script"   ,    "watchdog" , "reboot"        ,      "shutdown"        ,     "sup-output",

            "bandwidth-server",  "graphing"  ,  "romon" ,  "traffic-generator" ,"bandwidth-test" , "fetch"   ,    "mac-scan"  ,    "speed-test",  "wol",
            "calea"        ,     "mac-server",  "sms"    ,  "traffic-monitor"   , "dns-update"   ,   "flood-ping" , "mac-telnet" , "snmp-get",   "torch",
